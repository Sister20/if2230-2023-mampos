...
/**
 *find_empty_cluster, search an empty cluster
 * @return an empty cluster
 */
uint32_t find_empty_cluster(void);

/**
 *parent_cluster_valid, determine is parent cluster valid
 * @return true if parent cluster is valid
 */
...
/**
 *file_exist, determine is file exist
 * @return true if file exist in FAT
 */
